...
export function HeroSection() {
  return (
    <section className="flex flex-col">
      ...
      <nav className="md:flex justify-between px-40 mt-10 h-14 items-center hidden text-white md:text-2xl bg-black bg-opacity-15 font-Karla ">
        <a href="" className="">
          Galeria
        </a>
        <a href="">Sobre nós</a>
      ...
      <div className=" mt-16 md:mt-8 lg:mt-20 xl:mt-36 ml-52 md:ml-96 lg:pl-36 xl:pl-[360px] flex flex-col w-fit text-white ">
        <h1 className="font-Julius text-lg md:text-5xl lg:text-6xl xl:text-7xl">
          Cabana do
        </h1>
        <h2 className="font-Julius text-lg md:text-6xl lg:text-7xl xl:text-8xl">
          Pórtico
        </h2>
